  ...
  render() {
    ...
    return (
      <div className='card-text-center' style={{width: "20rem", border: "solid", margin: "40px", height: "550px"   }}>
        ...
        <button className='btn btn-primary'  style={{margin:'5px'}} onClick={this.createOffer}>CALL</button>
        <button  className='btn btn-primary' style={{maring:'5px'}} onClick={this.createAnswer}>ANSWER</button>
